...
#    np.save(args.npy_path, tissue_mask)
    ...
    for eachfile in files:
        ...
        slide = openslide.OpenSlide(args.wsi_path+eachfile)
#        filename = eachfile
        ...
        np.save(args.npy_path+eachfile[:-4], tissue_mask)
        ...
        logging.info(
            '{}, filename : {}, Processing : {}/{}, Run Time : {:.2f}'
            .format(
                time.strftime("%Y-%m-%d %H:%M:%S"), slide,
                count, len(files), time_spent))   
